      ...
      <div className="aws-container">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
            <a href="/documents/Resume_Paul_Debarbouille_2026.pdf" download="Resume_Paul_Debarbouille_2026.pdf">
          ...
          <div className="flex flex-wrap justify-center gap-8 pt-4">
            <a 
              href="mailto:pauldebarbouille@gmail.com" 
            ...
            <a 
              href="https://www.linkedin.com/in/paul-debarbouille-3a8483287/" 
              target="_blank" 
